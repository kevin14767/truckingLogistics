...
export default function ReportScreen() {
  ...
  const parsedData: VerificationData = verificationData ? 
    JSON.parse(verificationData) : 
    { verificationResults: [], imageData: null };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoText}>Report ID: {Date.now()}</Text>
        ...
        <View style={styles.section}>
          ...
          {parsedData.verificationResults.map((item) => (
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerButton} onPress={handleFinish}>
          <Text style={styles.footerButtonText}>Complete</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
